...
const resources = {
  zh: {
    translation: {
      ...
      formBirthDesc: "该信息便于我们推算出您的中国生肖，中国八字，幸运石，守护神等信息",
  ...
  en: {
    translation: {
      ...
      formBirthDesc: "This information helps us calculate your Chinese zodiac, Bazi, lucky stone, guardian deity, etc.",
